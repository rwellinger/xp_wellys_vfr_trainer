...
const char *kSystemPrompt =
    ...
    "Weigh: controlled (Tower) vs. AFIS workload; a separate Ground-control "
    "frequency (an extra ground-control handoff, more RT workload); surrounding "
    "terrain and elevation (mountains, valley approaches); nearby controlled "
    "airspace (CTR/TMA) and traffic complexity; runway length, surface and "
    "count.\n"
